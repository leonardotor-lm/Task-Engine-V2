...
const FIELD_ALIASES = Object.freeze({
    ...
    venzadespues: "dueAfter",
    venzadentro: "dueWithin",
    vencesdespues: "dueAfter",
    vencesdentro: "dueWithin",
    vancedespues: "dueAfter",
    vancedentro: "dueWithin",
    vencespues: "dueAfter",
    venzedespues: "dueAfter",
    venzedentro: "dueWithin",
    venzedespués: "dueAfter",
    vencdespues: "dueAfter",
    vencdentro: "dueWithin",
    vencesdeSpues: "dueAfter",
    venzedespuesde: "dueAfter",
    venzedentrode: "dueWithin",
    venzeentre: "dueBetween",
    venzentre: "dueBetween",
    venSeentre: "dueBetween",
